...
public class CargoStatic {
    public static final CargoItem
            soil = new CargoItem("泥土", "岩石碎裂之后的产物", .1),
            stone = new CargoItem("石头", "星球深处的岩浆凝固后的产物", .1),
            iron = new CargoItem("铁矿", "", .1),
            copper = new CargoItem("铜矿", "", .1),
            crystal = new CargoItem("水晶矿", "", .1),
            gold = new CargoItem("金矿", "", .1);
    ...
    public static final WeaponItem
            ...
            chargeRifle = WeaponItemBuilder.create("ChargeRifle", "",
                    new Damage(0).setIfBreakBlock(false)).withFireTime(160)
